...
export const leadConversionTools = [
    {
...
export const allTools = [...leadCaptureTools, ...communicationTools, ...leadConversionTools, ...marketingTools, ...analysisTools, ...productivityTools];
...
export const tools = allTools.map(tool => ({
    ...tool,
    icon: tool.icon.displayName || 'default-icon' // Convert icon component to string for sitemap
}));
